...
export function AddressInput(model: AddressInputModel) {
	...
	return (
		<div style={{ ...model.style, display: "flex", flexDirection: "row", alignItems: "center", flexWrap: "wrap" }}>
			<input
				style={{ flexGrow: 1, ...(error === "" ? {} : { borderColor: "red" }) }}
				placeholder={model.placeholder || "0xadd12e55add12e55add12e55add12e55add12e55"}
				value={addressString}
				onChange={model.errorHandler.asyncWrapper(addressChanged)}
			/>
