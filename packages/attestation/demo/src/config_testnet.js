/**
 * This contains test net configuration data for the Data Hashing Record Authentication
 * contract demo.
 *
 * @author FreightTrust Foundation, (c) 2020
 * @version 1.0.0
 */
...
module.exports = {
  rpc: {
    ...
    address: "wss://xapi.testnet.freighttrust.network/lachesisws",
  },
  ...
  contract: {
    ...
    // @see https://github.com/freighttrust/data-hashing-authentication/blob/master/README.md
    abi:
