...
import "./modules/FreightTrustMintErrorCodes.sol";
import "./modules/FreightTrustMintBalanceGuard.sol";
import "./modules/FreightTrustMintCollateral.sol";
import "./modules/FreightTrustMintDebt.sol";
import "./modules/FreightTrustMintConfig.sol";

// FreightTrustMint implements the contract of core DeFi function
// for minting tokens against a deposited collateral. The collateral
// management is linked from the FreightTrust Collateral implementation.
...
// of any fee.
contract FreightTrustMint is Initializable, FreightTrustMintBalanceGuard, FreightTrustMintCollateral, FreightTrustMintDebt, FreightTrustMintConfig {
    // define used libs
    ...
    // ----------------------------
    // FreightTrust minter configuration
    // ----------------------------

    // addressProvider represents the connection to other FMint related
    // contracts.
    IFreightTrustMintAddressProvider public addressProvider;
    ...
    function initialize(address owner, address _addressProvider) public initializer {
        ...
        addressProvider = IFreightTrustMintAddressProvider(_addressProvider);

        // init the underlying party
        FreightTrustMintConfig.initialize(owner);
        FreightTrustMintCollateral.initialize();
        FreightTrustMintDebt.initialize();
    }
