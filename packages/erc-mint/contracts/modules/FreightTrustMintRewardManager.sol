...
// FreightTrustMintCore implements a balance pool of collateral and debt tokens
// for the related FreightTrust DeFi contract. The collateral part allows notified rewards
// distribution to eligible collateral accounts.
contract FreightTrustMintRewardManager is FreightTrustMintErrorCodes, IFreightTrustMintRewardManager
{
    // define used libs
