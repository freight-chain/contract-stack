...
// FreightTrustMintCore implements a calculation of different rate steps
// between collateral and debt pools to ensure healthy accounts.
contract FreightTrustMintCollateral is Initializable, ReentrancyGuard, FreightTrustMintErrorCodes
{
    // define used libs
    ...
    function _withdraw(address _token, uint256 _amount) internal returns (uint256) {
        ...
        IFreightTrustDeFiTokenStorage pool = IFreightTrustDeFiTokenStorage(getCollateralPool());
