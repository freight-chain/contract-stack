...
// FreightTrustDeFiTokenStorage implements a token pool used by the FreightTrust
// DeFi fMint protocol to track collateral and debt.
contract FreightTrustDeFiTokenStorage is Initializable, IFreightTrustDeFiTokenStorage
{
    // define used libs
    ...
    modifier onlyMinter() {
        require(msg.sender == address(addressProvider.getFreightTrustMint()), "token storage access restricted");
        _;
    }
