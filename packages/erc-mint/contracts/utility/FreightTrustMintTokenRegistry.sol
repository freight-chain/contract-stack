...
* list of tokens used by the FreightTrust fMint protocol.
*
* version 0.1.0
* license MIT
* author FreightTrust Foundation, Jiri Malek
*/
contract FreightTrustMintTokenRegistry is Initializable, Ownable, IFreightTrustMintTokenRegistry {
    ...
    // canMint informs if the specified token can be minted in FreightTrust DeFi.
