...
import "../interfaces/IFreightTrustMintAddressProvider.sol";
...
* version 0.1.0
* license MIT
* author FreightTrust Foundation, Jiri Malek
*/
contract FreightTrustMintAddressProvider is Initializable, Ownable, IFreightTrustMintAddressProvider {

    // ----------------------------------------------
    // Module identifiers used by the address storage
    // ----------------------------------------------
    //
    bytes32 private constant MOD_FANTOM_MINT = "freighttrust_mint";
    ...
    */
     ...
     */
    function getTokenRegistry() public view returns (IFreightTrustMintTokenRegistry) {
        return IFreightTrustMintTokenRegistry(getAddress(MOD_TOKEN_REGISTRY));
    }
     ...
     */
    function getRewardDistribution() public view returns (IFreightTrustMintRewardManager) {
        return IFreightTrustMintRewardManager(getAddress(MOD_REWARD_DISTRIBUTION));
    }
     ...
     */
    function getFreightTrustMint() public view returns (IFreightTrustMintBalanceGuard) {
        return IFreightTrustMintBalanceGuard(getAddress(MOD_FANTOM_MINT));
    }

    /**
     * setFreightTrustMint modifies the address of the FreightTrust fMint contract.
     */
    function setFreightTrustMint(address _addr) public onlyOwner {
        // make the change
     ...
     */
    function getCollateralPool() public view returns (IFreightTrustDeFiTokenStorage) {
        return IFreightTrustDeFiTokenStorage(getAddress(MOD_COLLATERAL_POOL));
    }
     ...
     */
    function getDebtPool() public view returns (IFreightTrustDeFiTokenStorage) {
        return IFreightTrustDeFiTokenStorage(getAddress(MOD_DEBT_POOL));
    }
