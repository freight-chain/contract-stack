...
import "../modules/FreightTrustMintRewardManager.sol";

// FreightTrustMintRewardDistribution implements the fMint rewards handling
...
contract FreightTrustMintRewardDistribution is Initializable, Ownable, FreightTrustMintRewardManager
{
    // define used libs
    ...
    function rewardCanClaim(address _account) public view returns (bool) {
        return addressProvider.getFreightTrustMint().rewardCanClaim(_account);
    }
    ...
    function rewardIsEligible(address _account) public view returns (bool) {
        return addressProvider.getFreightTrustMint().rewardIsEligible(_account);
    }
}