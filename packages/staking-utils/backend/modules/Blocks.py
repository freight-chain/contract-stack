...
class Blocks:
    def __init__(self, sfcContract, freighttrustApi, database):
    ...
    def __getBlock(self, blockHeight):
        block = self.__freighttrustApi.getBlock(blockHeight)
    ...
    def sync(self):
        ...
        latestBlockHeight = self.__freighttrustApi.getLatestBlockNumber()
