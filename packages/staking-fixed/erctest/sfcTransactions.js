...
class TransactionHandler {
  ...
  async newSignedTx({ accountFrom, to, value, memo = "", web3Delegate = "", turnLogsOff = false }) {
  ...
  async deployContract(abi, code) {
    ...
    console.log(
      "Your contract is being deployed in transaction at http://testnet.etherscan.io/tx/" + contract.transactionHash,
    );
    ...
    async function waitBlock() {
      while (true) {
        ...
        if (receipt && receipt.contractAddress) {
          console.log(
            "Your contract has been deployed at http://testnet.etherscan.io/address/" + receipt.contractAddress,
          );
          console.log(
