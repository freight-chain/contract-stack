  ...
  async lachesis() {
    ...
    res = await axios(
      this.post_config({
        ...
        params: ["0x7f9d1dbaf84d827b0840e38f555a490969978d20", "latest"],
        id: 1,
      }),
    );
    console.log(res.data);
    ...
    res = await axios(
      this.post_config({
        ...
        params: [
          "0xf865808609184e72a00082271094d6a37423be930019b8cfea57be049329f3119a3d800026a022ee12db5a53b2a43d79c3d5b30f26287817a785da4be80b85ea368c746b2e0fa06e7178582d58eb80e407062c4afc4f4634e2908ef1b874f36b93b94093902f66",
        ],
        id: 1,
      }),
    );
